...
enum HeartPieceReplacementOptions {
    HEART_PIECE_REPLACEMENT_RECOVERY_HEART,
    HEART_PIECE_REPLACEMENT_GREEN_RUPEE,
    HEART_PIECE_REPLACEMENT_BLUE_RUPEE,
    HEART_PIECE_REPLACEMENT_RED_RUPEE,
    HEART_PIECE_REPLACEMENT_PURPLE_RUPEE,
    HEART_PIECE_REPLACEMENT_HUGE_RUPEE,
    HEART_PIECE_REPLACEMENT_NOTHING,
};
