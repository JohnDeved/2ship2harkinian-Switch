...
enum AutoBankDepositNotificationOptions {
    AUTO_BANK_DEPOSIT_NOTIFICATION_OFF,
    AUTO_BANK_DEPOSIT_NOTIFICATION_MILESTONES,
    AUTO_BANK_DEPOSIT_NOTIFICATION_ALWAYS,
};
